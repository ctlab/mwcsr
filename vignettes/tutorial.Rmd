...
SCIP opt suite from \href{https://scipopt.org/#scipoptsuite}{official website}
and build it alongwith `scipstp` application.
...
visit \href{https://scipopt.org}{SCIP} website.
...
To run scipjack solver, you need to do install it from 