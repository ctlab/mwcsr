...
Load `mwcsr`, as well as `igraph` package, which contains function for graph manipulations.
...
In case CPLEX is not available, Virgo solver can be run in heuristic mode. 
